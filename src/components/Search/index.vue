        ...
        watch:{
            message(newVal){
                ...
                this.timer = setTimeout(()=>{
                    this.axios.get('/api/searchList?cityId='+cityId+'&kw=a'+newVal).then((res)=>{
...
<style scoped>
    #content .search_body{ flex:1; overflow:auto;position: absolute;top: 0;bottom: 0;margin-top: 99px;width: 100%}
    ...
    .search_body .search_result li{ border-bottom:1px #c9c9c9 dashed; overflow:hidden;padding: 10px 15px; box-sizing:border-box; display: flex;}
